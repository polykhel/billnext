package com.polykhel.billnext.config.timezone

import com.polykhel.billnext.IntegrationTest
import com.polykhel.billnext.repository.timezone.DateTimeWrapper
import com.polykhel.billnext.repository.timezone.DateTimeWrapperRepository
...
class HibernateTimeZoneIT {
    ...
    private fun generateSqlRequest(fieldName: String, id: Long): String =
        format("SELECT %s FROM app_date_time_wrapper where id=%d", fieldName, id)
