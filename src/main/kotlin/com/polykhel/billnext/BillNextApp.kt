...
import com.polykhel.billnext.config.ApplicationProperties
...
class BillNextApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes BillNext.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<BillNextApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(BillNextApp::class.java)
