package com.polykhel.billnext.config.audit;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.polykhel.billnext.domain.AbstractAuditingEntity;
import com.polykhel.billnext.domain.EntityAuditEvent;
import com.polykhel.billnext.repository.EntityAuditEventRepository;
...
public class AsyncEntityAuditEventWriter {
    ...
    private EntityAuditEvent prepareAuditEntity(final Object entity, EntityAuditAction action) {
        ...
        try {
            ...
            try {
                entityId = ((Long) privateField.get(entity)).toString();
            } catch (ClassCastException e) {
                entityId = (String) privateField.get(entity);
            }
